...
define myconfig.ACHIEVEMENT_CALLBACK = [
    ...
    LinkedAchievement(all_achievements='all'),
]
...
image locked_achievement = Image("images/no_achieve.png")

define -2 all_achievements = Achievement(
    name=_("Striking Achiever"),
    id="all_achievements",
    description=_("Achieve until you can't anymore."),
    unlocked_image=Transform("images/achieve_all.png"),
    hide_description=_("Get all other achievements."),
)

define striking_checker = Achievement(
    name=_("Striking Checker"),
    id="striking_checker",
    description=_("Take a look at everything in your room."),
    unlocked_image=Transform("striking_checker.png"),
    stat_max=12,
)
...
define good_ending = Achievement(
    name=_("Finally Free"),
    id="good_ending",
    description=_("Achieve the good ending."),
    unlocked_image=Transform("images/good_ending.png"),
    hide_description=True,
)

define bad_ending_1 = Achievement(
    name=_("The World Will Remain The Same Forevermore"),
    id="bad_ending_1",
    description=_("Achieve the first bad ending."),
    unlocked_image=Transform("images/bad_ending_1.png"),
    hide_description=True,
)

define bad_ending_2 = Achievement(
    name=_("Hesitation Is The Enemy Of Growth"),
    id="bad_ending_2",
    description=_("Achieve the second bad ending."),
    unlocked_image=Transform("images/bad_ending_2.png"),
    hide_description=True,
)

define cheater = Achievement(
    name=_("You Cheated, Didn't You?"),
    id="hidden_achievement",
    description=_("Or maybe you just played it again?"),
    unlocked_image=Transform("images/cheater.png"),
    hidden=True,
)
...
screen achievement_gallery():
    ...
    label __("Achievements: ") + "{earned}/{total}".format(
        ...
        text_size 52 xalign 0.5 text_color "#841fea" top_padding 15
